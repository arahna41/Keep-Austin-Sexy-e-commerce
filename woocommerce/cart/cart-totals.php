...
?>
<div class="cart_totals total_summary <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">

	<?php do_action('woocommerce_before_cart_totals'); ?>

	<h4><?php esc_html_e('Cart totals:', 'woocommerce'); ?></h4>

	<div class="shop_table shop_table_responsive total_list">

		<div class="total_section subtotal cart-subtotal">
		...
		?>
					<div class="total_section tax-rate tax-rate-<?php echo esc_attr(sanitize_title($code)); ?>">
				...
				?>
				<div class="tax-total total_section">
		...
		<div class="order-total total_section grand_total">
