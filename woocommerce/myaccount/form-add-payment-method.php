...
?> <div class="account__my_info_head">
	<h3 class="account__h3 text_24">Add payment method</h3>
</div> <?php

if ( $available_gateways ) : ?>
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			<ul class="woocommerce-PaymentMethods payment_methods methods account_payment_methods">
				<?php
				// Chosen Method.
			...
			<div class="form-row">
				...
				<button type="submit" class="btn_style woocommerce-Button woocommerce-Button--alt button alt" id="place_order" value="<?php esc_attr_e( 'Add payment method', 'woocommerce' ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></button>
