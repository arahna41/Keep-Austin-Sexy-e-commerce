...
<form method="post" class="woocommerce-ResetPassword lost_reset_password account__log_in">
	...
	<h3 class="text_18"><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Enter a new password below', 'woocommerce' ) ); ?></h3><?php // @codingStandardsIgnoreLine ?>
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="woocommerce-Button button btn_style" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
	</p>
